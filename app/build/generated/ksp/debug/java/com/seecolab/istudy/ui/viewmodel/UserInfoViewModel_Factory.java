...
public final class UserInfoViewModel_Factory implements Factory<UserInfoViewModel> {
  ...
  public static UserInfoViewModel_Factory create(Provider<UserRepository> userRepositoryProvider,
      Provider<AuthenticationGuard> authenticationGuardProvider) {
    return new UserInfoViewModel_Factory(userRepositoryProvider, authenticationGuardProvider);
  }

  public static UserInfoViewModel newInstance(UserRepository userRepository,
      AuthenticationGuard authenticationGuard) {
    return new UserInfoViewModel(userRepository, authenticationGuard);
  }
}
