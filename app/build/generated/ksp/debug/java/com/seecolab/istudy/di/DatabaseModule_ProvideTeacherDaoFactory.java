...
public final class DatabaseModule_ProvideTeacherDaoFactory implements Factory<TeacherDao> {
  ...
  public DatabaseModule_ProvideTeacherDaoFactory(Provider<StudyDatabase> databaseProvider) {
    this.databaseProvider = databaseProvider;
  }

  @Override
  public TeacherDao get() {
    return provideTeacherDao(databaseProvider.get());
  }

  public static DatabaseModule_ProvideTeacherDaoFactory create(
      Provider<StudyDatabase> databaseProvider) {
    return new DatabaseModule_ProvideTeacherDaoFactory(databaseProvider);
  }

  public static TeacherDao provideTeacherDao(StudyDatabase database) {
    return Preconditions.checkNotNullFromProvides(DatabaseModule.INSTANCE.provideTeacherDao(database));
  }
}
