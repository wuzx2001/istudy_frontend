...
public final class AddParentViewModel_Factory implements Factory<AddParentViewModel> {
  ...
  public AddParentViewModel_Factory(Provider<UserRepository> userRepositoryProvider,
  ...
  @Override
  public AddParentViewModel get() {
    return newInstance(userRepositoryProvider.get(), authenticationGuardProvider.get());
  }

  public static AddParentViewModel_Factory create(Provider<UserRepository> userRepositoryProvider,
      Provider<AuthenticationGuard> authenticationGuardProvider) {
    return new AddParentViewModel_Factory(userRepositoryProvider, authenticationGuardProvider);
  }

  public static AddParentViewModel newInstance(UserRepository userRepository,
      AuthenticationGuard authenticationGuard) {
    return new AddParentViewModel(userRepository, authenticationGuard);
  }
}
